    ...
    <div class="weui-tab__bd proinfo-tab-con" style="padding-top:87px;">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        <div class="weui-panel weui-panel_access">
          <div class="weui-panel__hd"><span>单号：2132165457654545</span><span class="ord-status-txt-ts fr">已签收</span></div>
          <div class="weui-media-box__bd  pd-10">
            <div class="weui-media-box_appmsg ord-pro-list">
              ...
              <div class="weui-media-box__bd">
                <h1 class="weui-media-box__desc"><a href="pro_info.html" class="ord-pro-link">春装2017新款女装韩版长袖衬衫女修身显瘦上衣蝴蝶结收腰衬衣</a></h1>
                <p class="weui-media-box__desc">尺码：L,颜色:白色</p>
      ...
      <div id="tab2" class="weui-tab__bd-item">
        ...
        <div class="weui-panel weui-panel_access">
          <div class="weui-panel__hd"><span>单号：2132165457654545</span><span class="ord-status-txt-ts fr">待付款</span></div>
          <div class="weui-media-box__bd  pd-10">
            <div class="weui-media-box_appmsg ord-pro-list">
              <div class="weui-media-box__hd"><a href="pro_info.html"><img class="weui-media-box__thumb" src="upload/pro3.jpg" alt=""></a></div>
              <div class="weui-media-box__bd">
          ...
          <div class="weui-panel__ft">
            <div class="weui-cell weui-cell_access weui-cell_link oder-opt-btnbox">
              <a href="javascript:;" class="ords-btn-dele">删除订单</a><a href="order_info2.html" class="ords-btn-com">去付款</a>
            </div>    
          </div>
        </div>
      ...
      <div id="tab5" class="weui-tab__bd-item">
        ...
        <div class="weui-panel weui-panel_access">
          ...
          <div class="weui-media-box__bd  pd-10">
           ...
           <div class="weui-panel__ft h-40" >
            <div class="weui-cell weui-cell_access weui-cell_link oder-opt-btnbox weui-cell-comment">
